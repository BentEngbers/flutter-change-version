...
exports.increaseBuildNumber = void 0;
...
function increaseBuildNumber(path) {
    const fullPath = (0, utils_1.convertToFullPath)(path);
    const yaml = (0, utils_1.parseYamlString)((0, utils_1.readYamlFile)(fullPath));
...
exports.increaseBuildNumber = increaseBuildNumber;
run();
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.parseYamlString = exports.writeYamlFile = exports.readYamlFile = exports.convertToFullPath = void 0;
const fs = __importStar(__nccwpck_require__(7147));
const path = __importStar(__nccwpck_require__(1017));
const yaml_1 = __nccwpck_require__(4083);
const FileNameYaml = 'pubspec.yaml';
function convertToFullPath(directory) {
    const fullPath = path.join(process.cwd(), directory, FileNameYaml);
    return fullPath;
}
exports.convertToFullPath = convertToFullPath;
function readYamlFile(fullPath) {
...
function writeYamlFile(fullPath, yamlString) {
    if (fs.existsSync(fullPath)) {
...
function parseYamlString(yamlContents) {
    try {
        const doc = (0, yaml_1.parseDocument)(yamlContents);
        return doc;
    }
    catch (e) {
...
class Version {
    constructor(buildMajor, buildMinor, buildPatch, buildNumber) {
    ...
    static fromString(versionString) {
        ...
        if (splitPlus.length !== 2) {
            throw Error(`The versionString "${splitPlus}" does not contain exactly one '+' symbol`);
        }
        ...
        if (splitPoint.length !== 3) {
            throw Error(`The buildName "${buildName}" does not contain exactly two '.' symbol`);
        }
        const [buildMajor, buildMinor, buildPatch] = splitPoint;
        return new Version(toInt(buildMajor), toInt(buildMinor), toInt(buildPatch), buildNumber);
    }
}
